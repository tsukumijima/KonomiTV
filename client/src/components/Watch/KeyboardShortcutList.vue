...
const LIVE_SHORTCUT_LIST: IShortcutList = {
    ...
    right_column: [
        ...
        },
        {
            ...
            icon_height: '22px',
            shortcuts: [
                { name: 'ポスト検索タブを表示する', keys: [{name: '［ (「)', icon: false}] },
                { name: 'タイムラインタブを表示する', keys: [{name: '］ (」)', icon: false}] },
                { name: 'キャプチャタブを表示する', keys: [{name: '_', icon: false}] },
                { name: '検索結果を更新する', keys: [{name: 'ポスト検索タブを表示', icon: false}, {name: '＼(｜)', icon: false}] },
                ...
                { name: 'ポスト入力フォームにフォーカスを当てる/フォーカスを外す', keys: [{name: 'Tab', icon: false}] },
                { name: 'ポストを送信する', keys: [{name: 'Twitter タブを表示', icon: false}, {name: Utils.CtrlOrCmd(), icon: false}, {name: 'Enter', icon: false}] },
                { name: 'クリップボード内の画像を<br>キャプチャとして取り込む', keys: [{name: 'ポスト入力<br>フォームにフォーカス', icon: false}, {name: Utils.CtrlOrCmd(), icon: false}, {name: 'V', icon: false}] },
            ]
        },
        {
            name: 'データ放送',
