...
const showReanalyzeModal = async () => {
    // 既存の取得処理を無効化
    channelFetchRequestId += 1;
    const requestId = channelFetchRequestId;
