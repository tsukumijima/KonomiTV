...
export default Vue.extend({
    ...
    methods: {
        ...
        decorateProgramInfo(program: any, key: string): string {
        ...
        getAttribute(items: any, key: string, default_value: any): any {
        ...
        // 番組の放送時刻を取得する
        getProgramTime(program: any, is_short: boolean = false): string {
        ...
        // 番組の進捗状況を取得する
        getProgramProgress(program: any): number {
