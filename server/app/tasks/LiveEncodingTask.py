...
class LiveEncodingTask():
    ...
    def buildFFmpegOptions(self, quality:str, is_dualmono:bool=False) -> list:
        ...
        options.append('-aspect 16:9 -r 30000/1001 -g 15 -preset veryfast -profile:v main -level 31')
    ...
    def buildHWEncCOptions(self, encoder_type:str, quality:str, is_dualmono:bool=False) -> list:
        ...
        options.append(f'--dar 16:9 --gop-len 15 --profile main --level 3.1 --interlace tff')
        ## インターレース解除
    ...
    def run(self, channel_id:str, quality:str) -> None:
        ...
        tsreadex = subprocess.Popen(
            [
                ...
                '-c', '1',
                # 文字スーパーストリームがを常に削除する
                ## 現状、字幕と文字スーパーを一つの ID3 timed-metadata に変換するとエンコーダーが落ちるため
                '-u', '2',
