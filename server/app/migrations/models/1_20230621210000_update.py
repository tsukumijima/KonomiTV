...
CREATE TABLE IF NOT EXISTS "recorded_videos" (
    ...
    "recording_start_margin" REAL,
    "recording_end_margin" REAL,
    "duration" REAL NOT NULL,
    "container_format" VARCHAR(255) NOT NULL,
    "video_codec" TEXT NOT NULL,
    "video_resolution" TEXT NOT NULL,
    "primary_audio_codec" TEXT NOT NULL,
    "primary_audio_channel" TEXT NOT NULL,
    "secondary_audio_codec" TEXT,
    "secondary_audio_channel" TEXT,
    "cm_intervals" JSON
);
